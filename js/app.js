    ...
    function initLanguages() {
        if (document.querySelector(".language-selector")) {
            ...
            document.addEventListener("click", (e => {
                if (!wrapper.classList.contains(activeClass) && e.target.closest(".language-selector__button")) wrapper.classList.add(activeClass); else if (wrapper.classList.contains(activeClass) && !e.target.closest("language-selector")) wrapper.classList.remove(activeClass);
            }));
        }
    }
